...
st.markdown(f"""
    ...
    [data-testid="stSidebar"] {{ 
        ...
        border-right: 1px solid rgba(255,255,255,0.4); min-width: 350px !important; 
    ...
    button[data-testid="stNumberInputStepDown"], button[data-testid="stNumberInputStepUp"] {{ background-color: #ffffff !important; color: {COLOR_GRIS} !important; border-color: #e0e0e0 !important; font-weight: bold !important; transition: all 0.2s ease; }}
    ...
    /* --- MOBILE OPTIMIZATION (Se déclenche uniquement sur petit écran) --- */
    @media only screen and (max-width: 768px) {{
        ...
        .kpi-label {{ font-size: 0.7rem !important; margin-bottom: 5px; }}
        .kpi-sub {{ font-size: 0.75rem !important; margin-top: 3px; }}
        
        /* Tabs plus petits */
        .stTabs [data-baseweb="tab"] {{ padding: 0 10px !important; font-size: 0.8rem !important; height: 35px; }}
        
        /* Cacher les arcades sur mobile pour lisibilité */
        .arcades-overlay {{ display: none !important; }}
        
        /* Conclusion plus lisible */
        .conclusion-box {{ padding: 20px !important; }}
        .conclusion-title {{ font-size: 1.4rem !important; }}
        .conclusion-p {{ font-size: 1rem !important; line-height: 1.5; }}
    }}
...
with st.sidebar:
    ...
    with col_opt2: gli_active = st.checkbox("Option GLI (2.8%)", value=True)
...
# KPI CARDS (Layout auto-adaptatif grâce aux colonnes Streamlit)
# Astuce: On utilise des colonnes standards, le CSS gère le reste sur mobile
